...
header('Content-Type: application/json');
	 ...
	 extract($_POST);
                    ...
                    (SELECT COUNT(orderId) FROM   customer_order_master WHERE orderStatus = 0) AS ordersCount,
                    (SELECT COUNT(orderId) FROM   customer_order_master WHERE orderStatus = 6) AS alterCount
                    FROM dual";
