...
header('Content-Type: application/json');
	 ...
	 extract($_POST);
		 			...
		 			$academicQuery = mysqli_query($conn,"SELECT * FROM  stitch_style_template_master parent inner join stitch_style_details_template_master details on details.stitchStyleId = parent.stitchStyleId");
