...
if (isset($_POST['customerId']) && isset($_POST['firstName']) && isset($_POST['lastName']) && isset($_POST['email']) &&  isset($_POST['date_birth'])
&& isset($_POST['mobile'])
...
isActive='$isActive',issocial='$issocial' WHERE customerId='$customerId'";
				$query = mysqli_query($conn,$sql);
					$rowsAffected=mysqli_affected_rows($conn);
						if($rowsAffected > 0)
						{
					  			$response = array('Message'=>"Customer updated successfully",'Responsecode'=>200);
						}
						else
						{
