...
header('Content-Type: application/json');
	...
	$records= null;
	 ...
	 {
		 			$academicQuery = mysqli_query($conn,"SELECT * from product_master where ownerId = $ownerId order by productId desc");
								...
								while($academicResults = mysqli_fetch_assoc($academicQuery))
									{
										...
										$QueryOrderItem = mysqli_query($conn,"select * from  customer_order_items_master oi inner join product_master pm on oi.productid = pm.productid where oi.productId=$tempProductId");
