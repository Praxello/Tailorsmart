...
header('Content-Type: application/json');
	 ...
	 extract($_POST);
	  ...
	  // customer_appointment_master
		 			$academicQuery = mysqli_query($conn,"SELECT * FROM customer_appointment_master cam inner join appointment_slots slot on cam.slotid = slot.slotId inner join customer_master cm on cam.customerid = cm.customerid inner join employee_master em on em.employeeId = cam.servingEmployeeId");
