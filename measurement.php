...
<body class="fix-header fix-sidebar">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Measurement</h3> </div>
                ...
                <div class="row" id="customerstyletable" style="display:block;">
                    <div class="col-12">
                        <div class="card">
                          <div class="row">
                            <div class="col-md-12">
                              <button type="button" id="button1" class="btn btn-success" onclick="addStyle()" style="float:right"> New Measurement</button>
                              <div id="data"></div>
                          </div>
                          </div>
                            <div class="card-body">
                    ...
                    <div class="card">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group required">
                          <label class="control-label">Measurement Title</label>
    ...
    <script src="javascript/measurement.js"></script>
