                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            ${
                              navigation
                                ? '<div class="mg-prev" style="cursor:pointer;position:absolute;top:50%;left:2%;background:white;">prev</div>'
                                : '<span style="display:none;" />'
                            }
                            <img class="lightboxImage img-fluid" />
                            ${
                              navigation
                                ? '<div class="mg-next" style="cursor:pointer;position:absolute;top:50%;right:2px;background:white;}">next</div>'
                                : '<span style="display:none;" />'
                            }
                        </div>
                    </div>
