      ...
      <?php include('sidebar.php');?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <button type="button" class="btn btn-success" onclick="loadpage()">Add invoice</button>
                <!-- End PAge Content -->
            </div>
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2018 All rights reserved. Template designed by <a href="https://colorlib.com/">xxovek</a></footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
