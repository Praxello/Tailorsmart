                ...
                <div class="row" id="customerstyletable" style="display:block;">
                    ...
                    <div class="col-12">
                        <div class="card">
                          <div class="row">
                            <div class="col-md-12">
                              <button type="button" id="button1" class="btn btn-success" onclick="addStyle()" style="float:right">Create new promo code</button>
                              <div id="data"></div>
                          </div>
                          </div>
                            <div class="card-body">
                    ...
                    <div class="card">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group required">
                          ...
                          <input type="text" class="form-control" id="promocode"  title="Enter Promo code"/>
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="form-group required">
